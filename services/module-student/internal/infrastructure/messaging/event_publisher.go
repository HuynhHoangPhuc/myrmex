...
// EventPublisher publishes Student domain events via the configured messaging backend.
// Implements command.EventPublisher.
type EventPublisher struct {
	pub messaging.Publisher
}

// NewEventPublisher wraps a messaging.Publisher for Student domain events.
